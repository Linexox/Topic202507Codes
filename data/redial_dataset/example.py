...
file_path = "datasets/redial_dataset/train_data.jsonl"
...
# info = {"dataset_name": "Redial", "size": len(data), "example_entry": data[0]}
print("Dataset Name: Redial")
print("Dataset Size:", len(data))  # 10006
print("Example Entry:", json.dumps(data[0], indent=2))
"""
{
  "movieMentions": {
